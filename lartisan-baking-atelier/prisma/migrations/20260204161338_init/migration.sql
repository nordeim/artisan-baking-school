...
-- CreateIndex
CREATE INDEX "Course_categoryId_published_idx" ON "Course"("categoryId", "published");

-- CreateIndex
CREATE INDEX "Course_featured_published_idx" ON "Course"("featured", "published");
...
-- CreateIndex
CREATE INDEX "Progress_userId_videoId_idx" ON "Progress"("userId", "videoId");
